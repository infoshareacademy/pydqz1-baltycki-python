...
@allure.parent_suite('Checkout Feature - DESKTOP 1366x768')
...
class TestCheckoutFeature:
    ...
    def test_terms_checkbox(self, desktop_1366_768, mail, password):
    ...
    @pytest.mark.parametrize('mail, password', [('varihig924@era7mail.com', '12345')])
    def test_checkout_2_items(self, desktop_1366_768, payment_option, mail, password):
    ...
    def test_checkout1000000_items(self, desktop_1366_768, payment_option, mail, password):

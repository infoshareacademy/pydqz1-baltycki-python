...
@allure.parent_suite('Checkout Feature - MOBILE 360x640')
...
class TestCheckoutFeature:
    ...
    def test_terms_checkbox(self, mobile_360_640, mail, password):
    ...
    @pytest.mark.parametrize('mail, password', [('varihig924@era7mail.com', '12345')])
    def test_checkout_2_items(self, mobile_360_640, payment_option, mail, password):
    ...
    def test_checkout1000000_items(self, mobile_360_640, payment_option, mail, password):

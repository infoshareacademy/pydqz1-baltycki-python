...
@allure.parent_suite('Searching Products Feature - DESKTOP 1366x768')
...
class TestSearchingProducts:
    ...
    def test_search_bar_is_displayed(self, desktop_1366_768):
    ...
    def test_empty_search_query(self, desktop_1366_768):
        assert_that(self.searching_products.search_bar_is_displayed()).is_true()
    ...
    def test_search_tshirt_query(self, desktop_1366_768):

...
@allure.parent_suite('Shopping Cart - MOBILE 414x896')
@allure.description("Tests validating proper shopping cart behaviour")
@pytest.mark.usefixtures('mobile_414_896')
class TestShoppingCart:
    ...
    def test_add_to_shopping_cart_logged_in(self, mobile_414_896):
    ...
    def test_add_to_shopping_cart_logged_out(self, mobile_414_896):
        # check the contents of the cart visible on the main page - it should be empty
        assert_that(self.shoppingCart.main_page_cart_status()).contains('(empty)')
        self.shoppingCart.select_cart()
        # check that 'Your shopping cart is empty.' alert is displayed when you enter the shopping cart
    ...
    def test_remove_item_from_shopping_cart_logged_in(self, mobile_414_896):
        self.shoppingCart.log_in()
        self.shoppingCart.go_back_to_main_page()
        self.shoppingCart.select_item()
        self.shoppingCart.add_to_cart()
    ...
    def test_proceed_to_checkout_logged_out(self, mobile_414_896):
        self.shoppingCart.select_item()
        self.shoppingCart.add_to_cart()
    ...
    def test_proceed_to_checkout_logged_in(self, mobile_414_896):
        self.shoppingCart.log_in()
        self.shoppingCart.go_back_to_main_page()
        self.shoppingCart.select_item()
        self.shoppingCart.add_to_cart()
    ...
    def test_details_view_logged_out(self, mobile_414_896):
        self.shoppingCart.select_item()
    ...
    def test_details_view_logged_in(self, mobile_414_896):
        self.shoppingCart.log_in()
        self.shoppingCart.go_back_to_main_page()
        self.shoppingCart.select_item()
        self.shoppingCart.move_to_details_view()
    ...
    def test_add_to_cart_check_contents(self, mobile_414_896):
        self.shoppingCart.select_item()
        self.shoppingCart.move_to_details_view()

...
@allure.parent_suite('Checkout Feature - HEADLESS 1920x1080')
...
class TestCheckoutFeature:
    ...
    def test_terms_checkbox(self, headless_1920_1080, mail, password):
    ...
    @pytest.mark.parametrize('mail, password', [('varihig924@era7mail.com', '12345')])
    def test_checkout_2_items(self, headless_1920_1080, payment_option, mail, password):
    ...
    def test_checkout1000000_items(self, headless_1920_1080, payment_option, mail, password):

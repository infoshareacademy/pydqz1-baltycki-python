...
class TestCheckoutFeature:
    ...
    def test_buying001(self, user, password):
        ...
        empty_cart = self.home.get_the_value(CommonPageLocators.CART_WIDGET_EMPTY)
        ...
        self.home.enter_to_input(CommonPageLocators.EMAIL_INPUT, user)
        self.home.enter_to_input(CommonPageLocators.PASSWORD_INPUT, password)
        self.home.click(CommonPageLocators.SIGN_IN_BUTTON)
        self.home.click(CommonPageLocators.PROCEED_TO_CHECKOUT_BUTTON)
        self.home.click(CommonPageLocators.TERMS_CHECK_BOX)
        self.home.click(CommonPageLocators.PROCEED_TO_CHECKOUT_BUTTON)
        self.home.click(CommonPageLocators.PAY_BY_BANK_WIRE)
        self.home.click(CommonPageLocators.PROCEED_TO_CHECKOUT_BUTTON)
    ...
    #     self.home = BasePage(self.driver)
    #     empty_cart = self.home.get_the_value(CommonPageLocators.SHOPPING_CART_WIDGET_EMPTY)
    #     assert '(empty)' == empty_cart, 'Cart is not empty, must contain (empty)'
    ...
    #     self.home = BasePage(self.driver)
    #     self.home.click(CommonPageLocators.SHOPPING_CART_WIDGET_EMPTY)

...
@allure.parent_suite('Searching Products Feature - MOBILE 414x896')
...
class TestSearchingProducts:
    ...
    def test_search_bar_is_displayed(self, mobile_414_896):
    ...
    def test_empty_search_query(self, mobile_414_896):
        assert_that(self.searching_products.search_bar_is_displayed()).is_true()
    ...
    def test_search_tshirt_query(self, mobile_414_896):
    ...
    @allure.description_html("""<h2>Page should display at least one product</h2>""")
    def test_search_dress_query(self, mobile_414_896):
        assert_that(self.searching_products.search_bar_is_displayed()).is_true()
        assert_that(len(self.searching_products.list_of_products())).is_greater_than(0)

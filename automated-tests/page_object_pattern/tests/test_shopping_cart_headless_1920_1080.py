...
@allure.parent_suite('Shopping Cart - HEADLESS 1920x1080')
...
class TestShoppingCart:
    ...
    def test_add_to_shopping_cart_logged_in(self, headless_1920_1080):
    ...
    def test_remove_item_from_shopping_cart_logged_in(self, headless_1920_1080):
        self.shoppingCart.log_in()
        self.shoppingCart.go_back_to_main_page()
        self.shoppingCart.select_item()
        self.shoppingCart.add_to_cart()
    ...
    def test_proceed_to_checkout_logged_out(self, headless_1920_1080):
        self.shoppingCart.select_item()
        self.shoppingCart.add_to_cart()
    ...
    def test_proceed_to_checkout_logged_in(self, headless_1920_1080):
        self.shoppingCart.log_in()
        self.shoppingCart.go_back_to_main_page()
        self.shoppingCart.select_item()
        self.shoppingCart.add_to_cart()
    ...
    def test_details_view_logged_out(self, headless_1920_1080):
        self.shoppingCart.select_item()
    ...
    def test_details_view_logged_in(self, headless_1920_1080):
        self.shoppingCart.log_in()
        self.shoppingCart.go_back_to_main_page()
        self.shoppingCart.select_item()
        self.shoppingCart.move_to_details_view()
    ...
    def test_add_to_cart_check_contents(self, headless_1920_1080):
        self.shoppingCart.select_item()
        self.shoppingCart.move_to_details_view()
